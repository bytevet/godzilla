...
### ENG-8 [MEDIUM] ✅ DONE (`<pending>`) Sink dedup marks SSRF sinks reported before the suppression check, and one-finding-per-instruction hides later distinct flows
