...
### LLM-8 [MEDIUM] ✅ DONE (`<pending>`) Prompt omits the rule's sanitizer/source definitions and few-shot calibration; parseVerdict accepts bare "false" as a drop signal
