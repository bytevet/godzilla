...
const (
	...
	mutHex  = "#8b929e"
	dimHex  = "#5f6672"
	// The unfilled bar track. Must clear the background of a DARK terminal, which
	// #252a32 did not: 1.01:1 on One Dark, 1.04:1 on Solarized, i.e. invisible.
	// It reads only on a light background, which this palette is not for.
	trackHex = "#4a5364"
)
...
var (
	idx256 = map[string]int{
		...
		fgHex: 255, mutHex: 246, dimHex: 241, trackHex: 239,
	}
